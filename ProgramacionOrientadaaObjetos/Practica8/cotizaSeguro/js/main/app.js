const formulario = document.getElementById('cotizar-seguro');//id de todo el formulario
eventListener();
llenarSelectAnio();
...
function CotizarSeguro(event){
    ...
    const tipo = document.querySelector('input[name="tipo"]:checked').value//obtenemos el input de name tipo que este checeado
